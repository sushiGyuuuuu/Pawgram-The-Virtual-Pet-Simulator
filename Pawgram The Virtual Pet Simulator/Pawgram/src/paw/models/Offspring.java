...
public class Offspring implements Serializable {
    ...
    public Offspring(String name, String species, String gender, Pets parent1, Pets parent2) {
        this.name = name;
        this.species = species; // REMOVED: .toLowerCase() to preserve original case
        this.gender = gender;
        ...
        // NEW: Inherit traits from parents
    ...
    public int getRequiredGrowth() { return requiredGrowth; } // NEW: Added missing getter
    public Pets getParent1() { return parent1; }
    public Pets getParent2() { return parent2; }

    // NEW: Getters for inherited traits
    ...
    // NEW: Inherit temperament (random from parents or mix)
    ...
    // NEW: Inherit environment preference
    ...
    /**
     * Progresses growth by 1 action.
     * @return true if a stage-up happened.
     */
    ...
    // NEW: Helper method to create pet by species
    ...
    // NEW: Handle hybrid species or fallback
    ...
    // NEW: Get default accessory based on species
